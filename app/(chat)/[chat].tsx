...
export default function ChatRoomScreen() {
  ...
  React.useEffect(() => {
    ...
    const channel = `databases.${appwriteConfig.db}.tables.${appwriteConfig.col.chatRooms}.rows.${chatRoomId}`;
      ...
      <Stack.Screen
        options={{
          ...
          headerRight: () => (
            ...
            >
              <IconSymbol name="gearshape" size={24} color="white" />
            </Link>
          ),
        }}
      />
          ...
          >
            ...
            >
              <IconSymbol
                name="paperplane"
                size={24}
                color={messageContent ? "white" : "gray"}
              />
            </Pressable>
          </View>
        </KeyboardAvoidingView>
